...
const Members = () => {
  ...
  return (
    <div style={{ paddingBottom: '2rem', paddingRight: '5rem', paddingLeft: '5rem' }}>
          ...
          return (
            ...
            >
              <span style={{ color: classColor, marginRight: '2px' }}>
                <Link color='inherit' href={member.character.profile_url} underline='hover'>
      ...
      <span style={{ color: 'white' }}>
        <Link color="inherit" href="https://raider.io/guilds/us/proudmoore/Acrimonious" underline="hover">
          ...
        </Link>
      </span>
    </div>
